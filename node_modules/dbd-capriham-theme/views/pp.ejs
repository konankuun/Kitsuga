...
<html lang="en">
   <head>
      ...
      <title><%=themeConfig.websiteName%> - Privacy Policy</title>
   ...
   <body class="fix-header card-no-border fix-sidebar">
      ...
      <div id="main-wrapper">
         ...
         <%-include('partials/header.ejs', {now:'pp'})%>
                     ...
                     <div class="card">
                        <div class="card-body">
                           <div>
                            ...
                            <li>
                            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to <%=themeConfig.privacypolicy.websitename%>.</p>
                            </li>
                            <li>
                            ...
                            <li>
                            <p><strong>Website</strong> refers to <%=themeConfig.privacypolicy.websitename%>, accessible from <a href="%7B%7BwebsiteUrl%7D%7D" rel="external nofollow noopener" target="_blank"><%=themeConfig.privacypolicy.websiteurl%></a></p>
                            </li>
                            <li>
                            ...
                            <ul>
                            <li>
                            <p>Discord username, ID and avatar</p>
                            </li>
                            <li>
                            <p>Usage Data</p>
                            </li>
                            ...
                            <ul>
                            <li>By email: <%=themeConfig.privacypolicy.supportemail%></li>
                            </ul>
                            </div>
                        </div>
                     </div>
      ...
      <script src="https://adn.siondevelopment.xyz/dbd-capri/src/js/jquery.peity.min.js"></script>
      <script src="https://adn.siondevelopment.xyz/dbd-capri/src/js/jquery.peity.init.js"></script>
